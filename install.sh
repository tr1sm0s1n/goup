...
usage() {
	this=$1
	cat <<EOF
$this: Download binaries for tr1sm0s1n/goup

Usage: $this [-b] bindir [-d] [tag]
    -b sets bindir or installation directory, defaults to './bin'
    -d turns on debug logging

    [tag] is a tag from https://github.com/tr1sm0s1n/goup/releases.
...
get_binaries() {
	case "$PLATFORM" in
	darwin/amd64) BINARIES="goup" ;;
	darwin/arm64) BINARIES="goup" ;;
	linux/386) BINARIES="goup" ;;
	linux/amd64) BINARIES="goup" ;;
	linux/arm64) BINARIES="goup" ;;
	*)
